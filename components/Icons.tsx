...
export const SettingsIcon= ({size=20,...p}:P) => <Wrapper {...p}>{svg(size,<><path d="M11 10.27 7 3.34"/><path d="m11 13.73-4 6.93"/><path d="M12 22v-2"/><path d="M12 2v2"/><path d="M14 12h8"/><path d="m17 20.66-1-1.73"/><path d="m17 3.34-1 1.73"/><path d="M2 12h2"/><path d="m20.66 17-1.73-1"/><path d="m20.66 7-1.73 1"/><path d="m3.34 17 1.73-1"/><path d="m3.34 7 1.73 1"/><circle cx="12" cy="12" r="2"/><circle cx="12" cy="12" r="8"/></>)}</Wrapper>;
export const HelpIcon    = ({size=20,...p}:P) => <Wrapper {...p}>{svg(size,<><path d="M2.992 16.342a2 2 0 0 1 .094 1.167l-1.065 3.29a1 1 0 0 0 1.236 1.168l3.413-.998a2 2 0 0 1 1.099.092 10 10 0 1 0-4.777-4.719"/><path d="M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3"/><path d="M12 17h.01"/></>)}</Wrapper>;
export const UserManualIcon = ({size=20,...p}:P) => <Wrapper {...p}>{svg(size,<><path d="M2 6h4"/><path d="M2 10h4"/><path d="M2 14h4"/><path d="M2 18h4"/><rect width="16" height="20" x="4" y="2" rx="2"/><path d="M15 2v20"/><path d="M15 7h5"/><path d="M15 12h5"/><path d="M15 17h5"/></>)}</Wrapper>;
...
export const XIcon    = ({size=22,...p}:P) => <Wrapper {...p}>{svg(size,<><path d="M18 6 6 18"/><path d="m6 6 12 12"/></>)}</Wrapper>;
