...
export const AttachIcon  = ({size=18,...p}:P) => <Wrapper {...p}>{svg(size,<path d="m21.44 11.05-9.19 9.19a6 6 0 0 1-8.49-8.49l9.19-9.19a4 4 0 0 1 5.66 5.66l-9.2 9.19a2 2 0 0 1-2.83-2.83l8.49-8.48"/>)}</Wrapper>;
...
export const XIcon       = ({size=20,...p}:P) => <Wrapper {...p}>{svg(size,<><line x1="18" y1="6" x2="6" y2="18"/><line x1="6" y1="6" x2="18" y2="18"/></>)}</Wrapper>;
...
export const StoreIcon   = ({size=20,...p}:P) => <Wrapper {...p}>{svg(size,<><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></>)}</Wrapper>;
